...
const OMEGA := 100.0               ## deg/s at full speed: an arm every GAP seconds
const FIRST := 1.8                 ## start of the turn -> first pass (spinning up from standstill)
const GAP := 1.8
const GAP_FAST := 1.25
const RAMP_FAST := 0.4             ## the flare: speeding up to the fourth pass's pace
const WIND_DOWN := 0.9
